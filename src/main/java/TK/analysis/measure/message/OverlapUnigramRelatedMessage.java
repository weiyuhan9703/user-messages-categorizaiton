...
public class OverlapUnigramRelatedMessage implements MessageMeasure {

    public String name() {
        return "Overlap, unigram (curr msg vs. related msg)";
    }
    ...
    public Double value( Message m ) {
        if ( m.related_msgid != null ) {
            ...
            if ( related != null ) {
                return 1.0 * Utils.overlapCharUnigram( m.content, related.content );
            }
        }
        return null;
    }
